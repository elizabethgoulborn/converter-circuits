# boost_calc is a function used to calculate the inductor current and 
# capacitor voltage transient and steady-state behaviour of a boost converter.
...
def boost_calc(V_in, t, T, D, L, C, R, I_L_i, V_C_i):
	...
	# Save V_in from being overwritten
	V_on = V_in
	...
	for k in range (0, len(t) - 1):
		...
		# MOSFET OFF				
			...
			# Derivatives
			div_I_L = (1/L)*(V_in - V_C[k])
			div_V_C = (1/C)*(I_L[k] - I_R[k])		
		
		# Euler's forward approximations
