# buck_boost_calc is a function used to calculate the inductor current and 
# capacitor voltage transient and steady-state behaviour of a buck-boost converter.
...
def buck_boost_calc(V_in, t, T, D, L, C, R, I_L_i, V_C_i):
